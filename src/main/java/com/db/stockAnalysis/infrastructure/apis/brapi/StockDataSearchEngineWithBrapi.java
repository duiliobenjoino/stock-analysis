package com.db.stockAnalysis.infrastructure.apis.brapi;
...
import com.db.stockAnalysis.domain.services.StockDataSearchEngine;
...
public class StockDataSearchEngineWithBrapi implements StockDataSearchEngine {
    ...
    List<BigDecimal> getHistoryPriceVariation(final TreeMap<LocalDate, BigDecimal> priceHistory) {
