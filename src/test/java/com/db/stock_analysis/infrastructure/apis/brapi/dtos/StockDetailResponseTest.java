package com.db.stock_analysis.infrastructure.apis.brapi.dtos;
...
import static com.db.stock_analysis.helpers.StockDetailResponseMockBuilder.mockHistoricalDataPrice;
...
class StockDetailResponseTest {
    ...
    void shouldThrowExceptionWhenReturnIsEmpty(StockDetailResponse stockDetailResponse) {
        final var customErrorException = assertThrows(CustomErrorException.class, stockDetailResponse::validateIfEmpty);
